 ...
 *
 * Exposed as window.NotesService.
 */
(function () {
    if (typeof window !== 'undefined' && window.NotesService) return;
    ...
    if (typeof module !== 'undefined' && module.exports) module.exports = NotesService;
})();
