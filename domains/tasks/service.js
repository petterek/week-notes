 ...
 *
 * Exposed as window.TaskService (browser).
 */
(function () {
    if (typeof window !== 'undefined' && window.TaskService) return;
    ...
    if (typeof module !== 'undefined' && module.exports) module.exports = TaskService;
})();
