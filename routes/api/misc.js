...
module.exports = function(deps) {
    ...
    if (pathname === '/api/save' && req.method === 'POST') {
        try {
            ...
            // Tags applied to a note are also added to the context's
            // availableThemes, so the Settings tag list reflects every
            // tag that's actually in use across notes.
            if (incomingTags && updates.tags && updates.tags.length) {
