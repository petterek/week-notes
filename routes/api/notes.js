...
module.exports = function(deps) {
    ...
    if (deleteNoteMatch && req.method === 'DELETE') {
        ...
        try {
            ...
            clearMeetingNoteRef(`${week}/${decoded}`);
            res.writeHead(200, { 'Content-Type': 'application/json' });
